...
Output
------
tableExists returns value of 1 for session-scope table and 2 for a global-scope table
- Returns out_var = 0 if the given DS does not exist in CAS
- Returns out_var = 1 if the given DS exists in CAS
